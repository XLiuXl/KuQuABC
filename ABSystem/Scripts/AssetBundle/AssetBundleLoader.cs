...
namespace ABSystem
{
    ...
    public class MobileAssetBundleLoader : AssetBundleLoader
    {
        ...
        override public void LoadBundle()
        {
            ...
            ////Debug.Log("_assetBundleCachedFile:"+ _assetBundleCachedFile);
            ...
            Debug.Log("_assetBundleSourceFile:" + _assetBundleSourceFile);
        ...
        protected virtual IEnumerator LoadFromPackage()
        {
            if (state != LoadState.State_Error)
            {
                ...
                Debug.Log("SFile:"+_assetBundleSourceFile);
