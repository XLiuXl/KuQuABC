...
namespace ABSystem
{
    ...
    public class AssetBundleManager : MonoBehaviour
    {
        ...
        IEnumerator LoadDepInfo()
        {
            ...
            string depFile = string.Format("{0}/{1}", path+"/Data/"+PlayerProfile.VLevel+"/"+PlayerProfile.VScene+"/"+PlayerProfile.VTitle+ "/AssetBundles", pathResolver.DependFileName);

            Debug.LogFormat("DepFile:{0}",depFile);
        ...
        public AssetBundleLoader Load(string path, int prority, LoadAssetCompleteHandler handler = null)
        {
            ...
            //Debug.Log((HashUtil.Get(path.ToLower())));
            Debug.Log("_AB_MODE_Load.......");
        ...
        internal AssetBundleLoader CreateLoader(string abFileName, string oriName = null)
        {
            ...
            {
                //Debug.Log("loaderCache.ContainsKey(abFileName)"+abFileName);
            ...
            else
            {
                ...
                //Debug.LogFormat("Manager:{0},Data:{1},Name:{2}", loader.bundleManager, loader.bundleData, loader.bundleName);
        ...
        void CheckNewLoaders()
        {
            if (_nonCompleteLoaderSet.Count > 0)
            {
                ...
                while (e.MoveNext())
                {
                    ...
                    //Debug.Log("current:"+e.Current.bundleName);
                }
