...
public class UISavedOption : MonoBehaviour
{
	...
	//public static bool isLevelClick = false;
	//public static bool isClassTitleClick = false;
	/// <summary>
	...
	public void SaveSelection () 
	{
		...
		Debug.Log ("Saved=>Key="+key+"=>value="+UIPopupList.current.value+"====>"+this.gameObject.name);
