...
#pragma warning restore 0414
...
#if LOG_ALL_MESSAGES
        Debug.Log("1.Messenger MarkAsPermanent \t\"" + eventType + "\"");
#endif
    ...
    static public void Cleanup()
    {
        ...
        foreach (KeyValuePair<string, Delegate> pair in eventTable)
        {
            ...
            {
#if LOG_ALL_MESSAGES
                        Debug.Log("===>2.Messenger MarkAsPermanent=>"+message);
                        Debug.Log("===>3..pair =>" + pair.Key);
#endif
