...
$SQLrequest = "SELECT * FROM ".$_SESSION['AccountTable']." WHERE id = '".USER_ID."'";
$SQLresult = mysqli_query($_SESSION['databaseConnection'], $SQLrequest) or die($SQLrequest." = GET DATA DATABASE ERROR!");
...
// REMEMBER : when you create a table, don't use its name directly, do the as for Account IP and Attempts (in AccountServerSettings.php)
